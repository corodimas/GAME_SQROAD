...
int main()
{
    pytexture.loadFromFile("image/char/squrrial.png");
    cartexture.loadFromFile("image/enemy/ca3.png");
    

    car.setTexture(cartexture);
    car.setScale(sf::Vector2f(0.5, 0.5));
    ...
    while (mywindow.isOpen())
    {
        ...
        if (character.getGlobalBounds().intersects(car.getGlobalBounds())) {
            x = 350;
            y = 800;
            walking = false;
        }
